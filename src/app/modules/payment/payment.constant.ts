...
export const SubscriptionPlans: SubscriptionPlans[] = ['1 month' , '6 months' , '1 year']

export const subscriptionPlansDetails: Record<string, { durationInMonths: number; price: number }> = {
